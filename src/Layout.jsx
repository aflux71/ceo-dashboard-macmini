...
const navItems = [
        ...
        { name: "Margin Tracker", icon: BarChart2, page: "ProfitabilityAnalysis", permission: "profitability" },
        { name: "Product Costing", icon: Calculator, page: "ProductCosting", permission: "product_costing" },
