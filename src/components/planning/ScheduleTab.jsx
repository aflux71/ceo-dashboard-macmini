    ...
    <div className="space-y-4">
      ...
      : view === "calendar" ? (
        ...
        <Card className="bg-zinc-900 border-zinc-800"><CardContent className="p-0 overflow-x-auto"><div className="min-w-[900px]">
          ...
          {filtered.map((b) => { const { batchDate, qcDate, fillDate } = b.dates; const totalDays = ganttDays.length; const dayIndex = (d) => { if (!d) return -1; return Math.round((new Date(d + "T12:00:00") - new Date(ganttDays[0] + "T12:00:00")) / 86400000); }; const bI = dayIndex(batchDate), qI = dayIndex(qcDate), fI = dayIndex(fillDate); return (
